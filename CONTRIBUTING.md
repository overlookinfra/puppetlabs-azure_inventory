...
- [Open an
  issue](https://github.com/puppetlabs/puppetlabs-azure_inventory/issues/new/choose)
  or [track an
  issue](https://github.com/puppetlabs/puppetlabs-azure_inventory/issues) you are
  patching.
...
- [Open a Pull
  Request](https://github.com/puppetlabs/puppetlabs-azure_inventory/compare)
